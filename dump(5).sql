...
--
-- Host: localhost
-- Generation Time: Aug 04, 2017 at 12:08 
...
(1, 'Cv vidéos', 3, 'La première action engagée par Face d\'un recruteur, alors que ceux-ci reçoivent aujourd\'hui un grand nombre de CV papier et de lettres de motivation, parfois stéréotypées », explique Eric Getenay, directeur opérationnel (en bénévolat de compétence) du club.', 'Screenshot from 2017-04-13 21-11-54.png', '', 'A l\'envoi d\'une candidature il est souvent difficile de ses démarquer. Face permets à des jeunes en recherche d\'emploi de réaliser des cv vidéos pour marquer le recruteur.', ''),
...
(9, 'Café d\'en face', 3, 'Tous les mois à l\'intermittant ', 'Article presse du 17-09-2016.jpg', '', 'Petit cercle de jeunes et de moins jeunes auquel nous aurions dû être invités.', 'Image montrant le déroulement d\'un café d\'en face'),
